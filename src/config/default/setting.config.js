...
module.exports = {
  ...
  systemName: 'WeMedia工具',         //系统名称
  copyright: '元寸霖',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://pro.ant.design', name: 'weMedia工具'},
    {link: 'https://github.com/Garelik-w/vue-antd-admin', icon: 'github'},
    {link: 'https://www.yuque.com/yuancunlin', name: '元寸霖'}
  ],
}
